                ...
                <div class="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
                    ...
                    <form id="create" class="relative w-full mt-6 space-y-8">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="email" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="mohammed@email.com">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="************">
                        </div>
                        <div class="relative">
