<section class="relative py-2 bg-yellow-400">
    <div class="flex items-center justify-between h-14 px-8 mx-auto max-w-7xl">
        ...
        <nav class="items-center justify-center hidden space-x-5 text-gray-200 md:flex lg:space-x-8">
            ...
            <a href="<?php echo URLROOT; ?> " x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false" class="relative inline-block px-1 text-base font-bold text-gray-700 uppercase transition duration-150 ease hover:text-gray-900">
